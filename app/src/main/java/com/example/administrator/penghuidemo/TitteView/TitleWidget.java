package com.example.administrator.penghuidemo.TitteView;
...
public class TitleWidget extends RelativeLayout implements View.OnClickListener {
    ...
    private  IconFontView mivBack;//左边返回键的按钮
    ...
    private  IconFontView mivRight1;//右边第一个图标的显示
    private RelativeLayout rlyt_miv_right2;//右边第二个按钮
    private IconFontView mivRight2;//右边第二个图标的显示
...
//    private View  view_stau;//电池栏的颜色
    ...
    private void initData(Context context) {
        ...
        this.mivBack= (IconFontView) findViewById(R.id.miv_back);
        ...
        this.mivRight1= (IconFontView) findViewById(R.id.miv_right1);
        this.rlyt_miv_right2 = (RelativeLayout) findViewById(R.id.rlyt_miv_right2);
        this.mivRight2= (IconFontView) findViewById(R.id.miv_right2);
